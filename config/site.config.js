...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'asoul@kazenoyukue.onmicrosoft.com',
  ...
  email: 'mailto:me@maboroshiyuki.xyz',
